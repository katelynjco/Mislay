...
public class SmelterBossHealth : MonoBehaviour
{
MenuManager menuManager;
    ...
    [SerializeField] Transform [] lavaSpawns;
    ...
    IEnumerator DeathAnimation()
    {
        ...
        foreach (Transform lavaSpawn in lavaSpawns)
        {
            Destroy(lavaSpawn.gameObject);
        }
        bossExplode.Stop();
    }
    ...
    void UnlockScreen()
    {
        ...
        playerManager.hasRocketUpgrade = true;
